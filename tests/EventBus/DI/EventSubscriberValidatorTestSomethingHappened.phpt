...
use Damejidlo\EventBus\DI\InvalidSubscriberException;
 ...
 * @see ValidSubscriber
 */
final class SomethingValidHappenedEvent implements IDomainEvent
{
...
class SomethingInvalidHappenedEvent implements IDomainEvent
{
...
final class IncorrectName implements IDomainEvent
{
